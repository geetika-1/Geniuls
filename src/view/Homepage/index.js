  ...
  return (
    <>
      ...
      <Box
        sx={{
          width: "100%",
          height: {xs:"75rem", sm:"80rem", md:950, lg:950},
          background: "#edeef3",
          position: "relative",
          display: "flex",
          alignItems: "center",
      ...
      >
        ...
        <Container sx={{ position: "relative" }}>
          <Stack direction={{xs:"column", sm:"column", md:"row"}} justifyContent={{xs:"center",sm:"center", md:"center"}} alignItems={{xs:"center",sm:"center"}} mt={{xs:11, sm:11, md:2, lg:2}} p={{xs:2,sm:5, md:2}}>
            <Box>
              <Typography
                variant="h3"
                sx={{ fontWeight: 100, color: "secondary.main" }}
              >
                Access 2700+
              </Typography>
              <Typography
...
"
      ...
      <Container>
        ...
        <Stack direction="column" gap={1}>
          <Stack direction="row" alignItems="center" gap={1} data-aos={"fade-up"}>
            ...
            <Stack direction="row" alignItems="center" gap={1} data-aos={"fade-down"}>
